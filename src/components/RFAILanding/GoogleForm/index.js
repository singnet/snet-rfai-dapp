  ...
  return (
    <Fragment>
      ...
      <div className={classes.googleFormMainContainer}>
        <div className={classes.googleFormWrapper}>
          ...
          <div className={classes.googleFormFooterContainer}>
            <p>
...
export default withStyles(useStyles)(GoogleForm);
